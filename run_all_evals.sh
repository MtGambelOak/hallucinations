...
python eval.py --scorer probe --dataset ultrafeedback --probe_id gemma2_9b_linear --save results/ultrafeedback_probe_gemma2_9b_linear.json
...
python eval.py --scorer probe --dataset ultrafeedback --probe_id gemma2_9b_lora_lambda_kl_0_05 --save results/ultrafeedback_probe_gemma2_9b_lora_kl.json
...
python eval.py --scorer probe --dataset ultrafeedback --probe_id llama3_1_8b_linear --model_id meta-llama/Meta-Llama-3.1-8B-Instruct --save results/ultrafeedback_probe_llama3_1_8b_linear.json
...
python eval.py --scorer probe --dataset ultrafeedback --probe_id llama3_1_8b_lora_lambda_kl_0_05 --model_id meta-llama/Meta-Llama-3.1-8B-Instruct --save results/ultrafeedback_probe_llama3_1_8b_lora_kl.json
...
python eval.py --scorer probe --dataset ultrafeedback --probe_id llama3_1_8b_lora_lambda_lm_0_01 --model_id meta-llama/Meta-Llama-3.1-8B-Instruct --save results/ultrafeedback_probe_llama3_1_8b_lora_lm.json
...
python eval.py --scorer probe --dataset ultrafeedback --probe_id qwen2_5_7b_linear --model_id Qwen/Qwen2.5-7B-Instruct --save results/ultrafeedback_probe_qwen2_5_7b_linear.json
...
python eval.py --scorer probe --dataset ultrafeedback --probe_id qwen2_5_7b_lora_lambda_kl_0_05 --model_id Qwen/Qwen2.5-7B-Instruct --save results/ultrafeedback_probe_qwen2_5_7b_lora_kl.json
